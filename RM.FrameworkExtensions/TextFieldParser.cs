namespace System.IO {
    ...
    public class TextFieldParser : IDisposable {
        ...
        private int peekedEmptyLineCount;
        ...
        /// </summary>
        public TextFieldParser(Stream stream, Encoding encoding)
        ...
        /// </summary>
        public TextFieldParser(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks)
        ...
        /// </summary>
        public TextFieldParser(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks, bool leaveOpen)
            : this(new StreamReader(stream, encoding, detectEncodingFromByteOrderMarks)) {
        ...
        /// </summary>
        public TextFieldParser(string path, Encoding encoding)
        ...
        /// </summary>
        public TextFieldParser(string path, Encoding encoding, bool detectEncodingFromByteOrderMarks)
        ...
        public string[] ReadFields() {
            ...
            if (line.Length == 0 || line[^1] == delimiterChar) {
        ...
        private string ParseFieldAfterOpeningQuote(ref string line, int startIndex, out int nextStartIndex) {
            ...
            do {
                ...
                if (!isQuoteClosed && i >= line.Length) {
                    ...
                    line += nextLine ?? throw CreateMalformedLineException(
        ...
        /// <summary>
        /// Closes and disposes the current <see cref="TextFieldParser"/> object.
        /// </summary>
        public void Dispose() {
            Dispose(true);
        ...
        /// <summary>
        /// Disposes of the current <see cref="TextFieldParser"/> object.
        /// </summary>
    ...
    /// <summary>
    /// An exception that is thrown when the <see cref="TextFieldParser.ReadFields"/> method cannot parse a row using the specified format.
    /// </summary>
    /// <remarks>
